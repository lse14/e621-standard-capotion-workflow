...
class SourceBootstrapReleaseBuildTests(unittest.TestCase):
    def test_production_inventory_covers_the_required_e621_component_and_lock_surface(self) -> None:
        ...
        self.assertEqual("source-bootstrap-e621-v5", module.audit_inventory(value, REQUIREMENTS)["releaseVersion"])
    ...
    def test_production_inventory_records_the_published_bootstrap_identity(self) -> None:
        ...
        self.assertEqual(
            "https://github.com/lse14/e621-standard-capotion-workflow/releases/download/source-bootstrap-e621-v5/cpython-3.11.15-win-amd64-940ceb4.zip",
            record["publishedUrl"],
        )
